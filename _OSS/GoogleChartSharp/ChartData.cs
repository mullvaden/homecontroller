...
namespace GoogleChartSharp
{
    class ChartData
    {
        ...
        public static string Encoded(decimal[] data)
        {
            return TextEncoding(data);

        }
        public static string Encode(ICollection<decimal[]> data)
        {
            return TextEncoding(data);

        }
        public static string Encode(decimal[] datain)
        {
            return TextEncoding(datain);
        }
        ...
        private static string TextEncoding(decimal[] data)
        {
            return "chd=t:" + textEncode(data);
        ...
        public static string TextEncoding(ICollection<decimal[]> data)
        {
            string chartData = "chd=t:";

            foreach (decimal[] objectArray in data)
            {
                chartData += textEncode(objectArray) + "|";
            }
        ...
        private static string textEncode(decimal[] data)
        {
            string chartData = string.Empty;
